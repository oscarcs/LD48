...
class HXCPP_CLASS_ATTRIBUTES  MenuState_obj : public ::flixel::FlxState_obj{
	...
	public:
		...
		::flixel::effects::particles::FlxEmitter parts;
		::flixel::ui::FlxButton playButton;
		::flixel::text::FlxText playText;
		::flixel::ui::FlxButton twitterButton;
		::flixel::FlxSprite splashBackground;
		virtual Void create( );
