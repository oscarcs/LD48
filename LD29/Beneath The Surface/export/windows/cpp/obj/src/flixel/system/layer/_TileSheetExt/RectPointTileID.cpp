...
{
HX_STACK_FRAME("flixel.system.layer._TileSheetExt.RectPointTileID","new",0xd8d2fe9e,"flixel.system.layer._TileSheetExt.RectPointTileID.new","flixel/system/layer/TileSheetExt.hx",118,0x9b6b4f03)
HX_STACK_THIS(this)
HX_STACK_ARG(id,"id")
...
{
		HX_STACK_FRAME("flixel.system.layer._TileSheetExt.RectPointTileID","destroy",0xca0c5238,"flixel.system.layer._TileSheetExt.RectPointTileID.destroy","flixel/system/layer/TileSheetExt.hx",125,0x9b6b4f03)
		HX_STACK_THIS(this)
		HX_STACK_LINE(126)
		this->rect = null();
		HX_STACK_LINE(127)
