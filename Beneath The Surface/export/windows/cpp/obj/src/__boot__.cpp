...
::TiledLevel_obj::__register();
::flixel::addons::editors::tiled::TiledMap_obj::__register();
::StringTools_obj::__register();
::StringBuf_obj::__register();
::Skeleton_obj::__register();
::Shrub_obj::__register();
::Shrine_obj::__register();
::Reg_obj::__register();
::Reflect_obj::__register();
::PlayState_obj::__register();
::Pillar_obj::__register();
::Mound_obj::__register();
...
::flixel::addons::display::FlxExtendedSprite_obj::__boot();
...
::flixel::addons::display::FlxMouseSpring_obj::__boot();
::flixel::addons::display::FlxSpriteAniRot_obj::__boot();
