...
{
HX_STACK_FRAME("EReg","new",0x8b859e81,"EReg.new","E:\\Haxe\\haxe\\std/cpp/_std/EReg.hx",28,0xbaaa1a43)
HX_STACK_THIS(this)
HX_STACK_ARG(r,"r")
...
bool EReg_obj::match( ::String s){
	HX_STACK_FRAME("EReg","match",0x18fda1a6,"EReg.match","E:\\Haxe\\haxe\\std/cpp/_std/EReg.hx",36,0xbaaa1a43)
	HX_STACK_THIS(this)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(37)
...
Array< ::String > EReg_obj::split( ::String s){
	HX_STACK_FRAME("EReg","split",0x9749433b,"EReg.split","E:\\Haxe\\haxe\\std/cpp/_std/EReg.hx",74,0xbaaa1a43)
	HX_STACK_THIS(this)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(75)
