...
class HXCPP_CLASS_ATTRIBUTES  File_obj : public hx::Object{
	...
	public:
		...
		static ::openfl::filesystem::File applicationDirectory;
		static ::openfl::filesystem::File applicationStorageDirectory;
		static ::openfl::filesystem::File desktopDirectory;
		static ::openfl::filesystem::File documentsDirectory;
		static ::openfl::filesystem::File userDirectory;
		static int APP;
		static int STORAGE;
		static int DESKTOP;
		static int DOCS;
