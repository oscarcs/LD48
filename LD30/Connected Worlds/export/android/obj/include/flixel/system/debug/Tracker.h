...
class HXCPP_CLASS_ATTRIBUTES  Tracker_obj : public ::flixel::system::debug::Watch_obj{
	...
	public:
		...
		static hx::ObjectPtr< Tracker_obj > __new(::String Title,::openfl::display::BitmapData Icon,Dynamic Width,Dynamic Height,Dynamic Resizable,::openfl::geom::Rectangle Bounds,Dynamic Closable);
