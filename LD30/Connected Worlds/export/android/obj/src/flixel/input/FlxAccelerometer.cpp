...
HX_STACK_THIS(this)
{
	...
	if ((::openfl::sensors::Accelerometer_obj::get_isSupported())){
		HX_STACK_LINE(39)
		::openfl::sensors::Accelerometer _g = ::openfl::sensors::Accelerometer_obj::__new();		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(39)
		this->_sensor = _g;
		HX_STACK_LINE(40)
		this->_sensor->addEventListener(::openfl::events::AccelerometerEvent_obj::UPDATE,this->updateCallback_dyn(),null(),null(),null());
	}
}
;
	return null();
...
bool FlxAccelerometer_obj::get_isSupported( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(46)
	return ::openfl::sensors::Accelerometer_obj::get_isSupported();
}
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::sensors::Accelerometer*/ ,(int)offsetof(FlxAccelerometer_obj,_sensor),HX_CSTRING("_sensor")},
	{ hx::fsUnknown, 0, null()}
};
#endif
