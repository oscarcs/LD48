	...
	HX_STACK_ARG(NewTile,"NewTile")
{
		...
		if (((bool((tile == null())) || bool(!(tile->visible))))){
			...
			HX_STACK_LINE(1479)
			::openfl::geom::Rectangle _g2 = ::openfl::geom::Rectangle_obj::__new((rx + this->region->startX),(ry + this->region->startY),this->_tileWidth,this->_tileHeight);		HX_STACK_VAR(_g2,"_g2");
			HX_STACK_LINE(1479)
			rect = _g2;
		}
		HX_STACK_LINE(1484)
		::openfl::geom::Point pt = ::openfl::geom::Point_obj::__new((int)0,(int)0);		HX_STACK_VAR(pt,"pt");
		HX_STACK_LINE(1485)
		...
		if (((bool((this->_auto == (int)2)) && bool((this->_data->__get(Index) == (int)15))))){
			struct _Function_2_1{
				inline static bool Block( hx::ObjectPtr< ::flixel::tile::FlxTilemap_obj > __this,int &Index){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/tile/FlxTilemap.hx",2141,0x448feb74)
					{
						HX_STACK_LINE(2141)
			...
			struct _Function_2_2{
				inline static bool Block( hx::ObjectPtr< ::flixel::tile::FlxTilemap_obj > __this,int &Index){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/tile/FlxTilemap.hx",2156,0x448feb74)
					{
						HX_STACK_LINE(2156)
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::geom::Point*/ ,(int)offsetof(FlxTilemap_obj,_flashPoint),HX_CSTRING("_flashPoint")},
	{hx::fsObject /*::openfl::geom::Rectangle*/ ,(int)offsetof(FlxTilemap_obj,_flashRect),HX_CSTRING("_flashRect")},
	...
	{hx::fsObject /*::openfl::geom::Point*/ ,(int)offsetof(FlxTilemap_obj,_helperPoint),HX_CSTRING("_helperPoint")},
