...
::String File_obj::lime_filesystem_get_special_dir( int which){
	HX_STACK_FRAME("openfl.filesystem.File","lime_filesystem_get_special_dir",0x56438de7,"openfl.filesystem.File.lime_filesystem_get_special_dir","openfl/filesystem/File.hx",103,0x4a92e11d)
	HX_STACK_ARG(which,"which")
	HX_STACK_LINE(105)
	if (((::openfl::filesystem::File_obj::jni_filesystem_get_special_dir == null()))){
		HX_STACK_LINE(107)
		...
		HX_STACK_LINE(107)
		::openfl::filesystem::File_obj::jni_filesystem_get_special_dir = _g;
	}
	HX_STACK_LINE(111)
	return ::openfl::filesystem::File_obj::jni_filesystem_get_special_dir(which);
}
