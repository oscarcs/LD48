...
{
HX_STACK_FRAME("openfl.sensors.Accelerometer","new",0xc90bd80e,"openfl.sensors.Accelerometer.new","openfl/sensors/Accelerometer.hx",22,0x246a7024)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(24)
	super::__construct(null());
	HX_STACK_LINE(26)
	this->setRequestedUpdateInterval(::openfl::sensors::Accelerometer_obj::__defaultInterval);
}
;
	return null();
}
...
bool useWeakReference = __o_useWeakReference.Default(false);
	HX_STACK_FRAME("openfl.sensors.Accelerometer","addEventListener",0x24c24f5f,"openfl.sensors.Accelerometer.addEventListener","openfl/sensors/Accelerometer.hx",31,0x246a7024)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("openfl.sensors.Accelerometer","setRequestedUpdateInterval",0x3228fd0c,"openfl.sensors.Accelerometer.setRequestedUpdateInterval","openfl/sensors/Accelerometer.hx",39,0x246a7024)
		HX_STACK_THIS(this)
		HX_STACK_ARG(interval,"interval")
		HX_STACK_LINE(41)
		if (((interval < (int)0))){
			HX_STACK_LINE(43)
			HX_STACK_DO_THROW(::openfl::errors::ArgumentError_obj::__new(null(),null()));
		}
		else{
			HX_STACK_LINE(45)
			if (((interval == (int)0))){
				HX_STACK_LINE(47)
				interval = ::openfl::sensors::Accelerometer_obj::__defaultInterval;
			}
		}
		HX_STACK_LINE(51)
		...
		HX_STACK_LINE(57)
		if ((::openfl::sensors::Accelerometer_obj::get_isSupported())){
			HX_STACK_LINE(59)
...
{
		HX_STACK_FRAME("openfl.sensors.Accelerometer","__update",0xdd1c52bb,"openfl.sensors.Accelerometer.__update","openfl/sensors/Accelerometer.hx",67,0x246a7024)
		HX_STACK_THIS(this)
		HX_STACK_LINE(69)
		...
		HX_STACK_LINE(70)
		Dynamic data = ::openfl::sensors::Accelerometer_obj::lime_input_get_acceleration();		HX_STACK_VAR(data,"data");
		HX_STACK_LINE(72)
...
bool Accelerometer_obj::get_isSupported( ){
	HX_STACK_FRAME("openfl.sensors.Accelerometer","get_isSupported",0x5d680929,"openfl.sensors.Accelerometer.get_isSupported","openfl/sensors/Accelerometer.hx",89,0x246a7024)
	HX_STACK_LINE(89)
	Dynamic _g = ::openfl::sensors::Accelerometer_obj::lime_input_get_acceleration();		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(89)
	return (_g != null());
}
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl.sensors.Accelerometer"), hx::TCanCast< Accelerometer_obj> ,sStaticFields,sMemberFields,
...
void Accelerometer_obj::__boot()
{
	...
	lime_input_get_acceleration= ::openfl::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_input_get_acceleration"),(int)0);
}
