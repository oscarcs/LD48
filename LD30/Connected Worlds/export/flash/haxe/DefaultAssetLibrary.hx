...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/data/dos437.ttf", __ASSET__assets_data_dos437_ttf);
		type.set ("assets/data/dos437.ttf", AssetType.FONT);
		className.set ("assets/data/perfect_dos_vga_437/dos437.txt", __ASSET__assets_data_perfect_dos_vga_437_dos437_txt);
		type.set ("assets/data/perfect_dos_vga_437/dos437.txt", AssetType.TEXT);
		className.set ("assets/data/perfect_dos_vga_437/Perfect DOS VGA 437.ttf", __ASSET__assets_data_perfect_dos_vga_437_perfect_dos_vga_437_ttf);
		...
		var id;
		id = "assets/data/dos437.ttf";
		className.set (id, __ASSET__assets_data_dos437_ttf);
		type.set (id, AssetType.FONT);
		id = "assets/data/perfect_dos_vga_437/dos437.txt";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "assets/data/perfect_dos_vga_437/Perfect DOS VGA 437.ttf";
		className.set (id, __ASSET__assets_data_perfect_dos_vga_437_perfect_dos_vga_437_ttf);
		type.set (id, AssetType.FONT);
...
@:keep class __ASSET__assets_data_dos437_ttf extends openfl.text.Font { }
...
@:font("assets/data/dos437.ttf") class __ASSET__assets_data_dos437_ttf extends flash.text.Font {}
